...
#===========================================================================
#
# Checkout and build soloii, using autoconf/automake and configure.
#
# This script performs the following steps:
#
#   1. clone lrose-soloii from git
...
def main():
    ...
    prefixDirDefault = '/tmp/soloii-install'
    buildDirDefault = '/tmp/soloii-build'
    logDirDefault = '/tmp/soloii-build/logs'
    ...
    parser.add_option('--tag',
                      ...
                      help='Tag to check out soloii. Overrides --releaseDate')
    ...
    soloiiDir = os.path.join(options.buildDir, "lrose-soloii")
    ...
    if (options.debug):
        ...
        print("  soloiiDir: ", soloiiDir, file=sys.stderr)
...
def gitCheckout():
    ...
    shellCmd("/bin/rm -rf lrose-soloii")
    if (options.tag == "master"):
        shellCmd("git clone https://github.com/NCAR/lrose-soloii")
    else:
...
def checkInstall():
    ...
    shellCmd("./checkSoloiiInstall.py" + \
                 " --prefix " + prefixDir)
    print("====================================================")
